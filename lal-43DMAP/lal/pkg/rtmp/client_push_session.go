...
func NewPushSession(protocol string,modOptions ...ModPushSessionOption) *PushSession {
	...
	return &PushSession{
		IsFresh: true,
		core: NewClientSession(CSTPushSession, protocol, func(option *ClientSessionOption) {
...
//get monitor information from quic
func (s *PushSession) ReturnMonitor()(flag bool, limit int) {
	return s.core.ReturnMonitor()
}

func (s *PushSession) ReturnSchName()(string) {
	return s.core.ReturnSchName()
}

func (s *PushSession) SetCWNDFlag(flag bool)() {
	s.core.SetCWNDFlag(flag)
}
