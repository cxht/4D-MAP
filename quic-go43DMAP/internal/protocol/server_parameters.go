...
//const DefaultMaxCongestionWindow = 5000	//cx
// InitialCongestionWindow is the initial congestion window in QUIC packets
const InitialCongestionWindow = 32
//const InitialCongestionWindow =  3000//cx
...
const ReceiveStreamFlowControlWindow = (1 << 20) * 160 // cx
...
const ReceiveConnectionFlowControlWindow = (1 << 20) * 200// 48 kB
...
const DefaultMaxReceiveStreamFlowControlWindowServer = 1 * (1 << 20) // cx
...
const MaxTrackedSentPackets = 300 * DefaultMaxCongestionWindow
...
//const MaxNonRetransmittablePackets = 2500
